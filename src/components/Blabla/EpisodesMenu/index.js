 ...
 * 1. Render the FilteredEpisodes component that contains the list of "filtered" episodes based on the tag selected by the user
 * 2. Render the AllEpisodesMenu component that makes a static GraphQL query to fetch all episodes and display them ...
 * ...(just like it was implemented before supporting tags).
 * The above decision is made based on whether the component receives a `tag` prop.
